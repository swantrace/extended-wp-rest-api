...
function idocalgary_get_ads($object, $field_name, $request){
    ...
    foreach ($raw_ads as $raw_ad):
        ...
        if($ad['type'] == 'post' || $ad['type'] == 'place' || $ad['type'] == 'advert' || $ad['type'] == 'topic'):
            $resource_type = $ad['type'] . '_item';
            $ad['resource'] = $raw_ad[$resource_type];
        endif;
        if($ad['type'] == 'exteral'):
            $ad['resource'] = $raw_ad['ad_exteranl_link'];
        endif;
        $ads[] = $ad;
    endforeach;
...
function idocalgary_get_advert_featured_image_url($object, $field_name, $present){
    ...
    if(empty($object['gallery'])):
        return "http://s3.amazonaws.com/52calgary-media/wp-content/uploads/2017/02/02154729/default-thumbnail.jpg";
    endif;
