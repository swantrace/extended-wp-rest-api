...
class Ido_REST_Attachments_Controller extends WP_REST_Posts_Controller {
	protected $post_type;
	protected $meta;
	public function __construct($post_type='attachment') {	
	...
	public function create_item( $request ) {
		...
		// var_dump($request['is_profile'], '<hr>', $name_parts, '<hr>', $name, '<hr>', $url, '<hr>', $type, '<hr>', $file); die();
